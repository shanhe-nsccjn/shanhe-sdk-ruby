...
module ShanHe
  module SDK
    module Contract
      USER_SUPPORT_DIRECTORY    = "#{Dir.home}/.shanhe".freeze
      USER_CONFIG_FILENAME      = 'config.yaml'.freeze
      USER_CONFIG_FILEPATH      = "#{USER_SUPPORT_DIRECTORY}/#{USER_CONFIG_FILENAME}".freeze

      # GEM_DIRECTORY             = Gem::Specification.find_by_name('shanhe-sdk').gem_dir
      # DEFAULT_SUPPORT_DIRECTORY = GEM_DIRECTORY + '/lib/shanhe/sdk/commons/default'
