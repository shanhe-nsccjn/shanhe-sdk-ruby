...
require 'shanhe/sdk/version'

Gem::Specification.new do |spec|
  spec.name    = 'shanhe-sdk'
  spec.version = ShanHe::SDK::VERSION
  ...
  spec.summary     = 'SDK for ShanHe'
  spec.description = 'The official ShanHe SDK for Ruby programming language.'
  spec.homepage    = 'https://github.com/shanhe-nsccjn/shanhe-sdk-ruby'
  ...
  spec.add_development_dependency 'rufo', '~> 0.5.0'
end
